...
class Service {
    ...
    call(args) {
        ...
        if (this.configObj.createRequest) {
            requestBody = this.configObj.createRequest(this, args);
        ...
        if (this.mock) {
            ...
            } else if (this.configObj.mockCall) {
                return this.configObj.mockCall(this, requestBody);
            }
        }
        ...
        if (this.configObj.parseResponse) {
            ...
            return new Result(
                this.configObj.parseResponse(this, this.getResponse())
            );
        }
